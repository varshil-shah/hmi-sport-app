                  ...
                  <div className="flex flex-col items-center justify-start w-[88%] md:w-full gap-6">
                    ...
                    <Text as="p">
                      <>
                        ...
                        Yes, I am talking about static websites.
                        <br />
                        Long ago, almost all websites were used to be static
                        sites during the early days of the internet. Then
                        dynamic sites came and blew the space. A lot of websites
                        shifted to it. Obviously dynamic sites have their
                        advantages. But static sites are making a comeback. And
                        it’s coming stronger than before. In this article, you
                        will cover the basics of static websites like what is a
                        static website, what are the advantages, and when you
                        should use a static website. Let’s kick things off.
                      </>
                    </Text>
                  </div>
                      ...
                      <div className="flex flex-col items-center justify-start w-full gap-10 p-[38px] sm:p-5 border-blue_gray-100_01 border border-solid bg-white-A700 rounded-[10px]">
                        ...
                        <div className="flex flex-col items-start justify-start w-[98%] md:w-full pt-[3px] gap-4">
                          ...
                          <div className="flex flex-col items-center justify-start pt-1.5 gap-5">
                            ...
                            <Text as="p">
                              Unlike dynamic websites, you don’t have to depend
                              on plugins to add functionalities to your static
                              site. Instead, you can create or include features
                              directly into files. Or, you can insert widgets
                              using a snippet.
                            </Text>
                          </div>
                        </div>
                    ...
                    <div className="flex flex-col items-center justify-start w-full gap-4">
                      ...
                      <div className="flex flex-row sm:flex-col justify-start items-center w-full gap-3 sm:gap-3">
                        ...
                        <Heading
                          size="md"
                          as="h6"
                          className="mt-[5px] sm:mt-0 !text-gray-600_02"
                        >
                  ...
                  <div className="flex flex-col items-center justify-start w-full gap-4">
                    <div className="flex flex-row justify-start w-full gap-[15px] sm:gap-[15px]">
                      <Heading
                        size="md"
                        as="h6"
                        className="h-[25px] mt-[3px] mb-0.5 !text-gray-600_02 !font-bold"
                      >
                        01.
                      </Heading>
                    ...
                    <div className="flex flex-row justify-start w-full gap-[13px] sm:gap-[13px]">
                      <Heading
                        size="md"
                        as="h6"
                        className="mt-[3px] mb-0.5 !text-gray-600_02 !font-bold"
                      >
                        02.
                      </Heading>
                      <Heading size="md" as="h6" className="!text-gray-600_02">
                    ...
                    <div className="flex flex-row sm:flex-col justify-start w-full gap-3 sm:gap-3">
                      <Heading
                        size="md"
                        as="h6"
                        className="mt-[3px] mb-0.5 sm:mt-0 !text-gray-600_02 !font-bold"
                      >
                        03.
                      </Heading>
                      <Heading size="md" as="h6" className="!text-gray-600_02">
